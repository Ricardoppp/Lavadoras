...
<body>
    ...
    <nav>
        <ul class="nav justify-content-center"> <!-- indica que la barra este en el centro  -->
            ...
            <a class="nav-link" href="lavadoras.php">Lavadoras</a> <!-- Link del html para lavadoras  -->
            </li>
            <li class="nav-item"> <!-- Esto crea un nuevo item -->
    ...
    <div class="circulos_Lavadoras">  <!-- Crean donde el div donde iran las 3 imagenes en forma de ciculo, cada imagen, sera redirigido a la pagina correspondiente -->
        <a href="/Lavadoras/lavadoras.php"> <!-- Crea un link al HTML respectivo  -->
    ...
    <section class="mas_vendidas"> <!-- Crea una seccion donde iran las lavadoras mas vendias y la informacion de estas, el porque son las mas vendias  -->
        <div class="card" style="width: 18rem;"> <!-- Crea el div con el espacio para ingresar el producto -->
            ...
            <div class="card-body"> <!-- Esto es para crear la informacion que tendra el pruccto (valor, referencias, etc...) -->
                ...
                <p class="card-text">2 en 1 - Lava y seca. Ahorra espacio, tiempo y energía.</p>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Digital Inverter - Ahorro de energía & 20 años de garantía en el motor.</p>
                <div class="cart-favorites">
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <h5 class="card-title">Lavadora Whirpool</h5>
                <p class="card-text">TurboWash3D™ - Ahorra agua y tiempo. 10 años de garantía en el motor Inverter Direct Drive.</p>
                <div class="cart-favorites">
                    <a href="#" class="btn-btn-primary"><i class="bi bi-cart"></i></a> 
                    <a href="#" class="btn-btn-secondary"><i class="bi bi-heart"></i></a>
                </div>
        ...
        <div class="card" style="width: 18rem;">
            <img src="Images/1.png" class="card-img-top" alt="..." height="270px" width="200px">
            <div class="card-body">
                <h5 class="card-title">Lavadora Mabe</h5>
                <p class="card-text">EcoBubble™ y tecnología AddWash™ para una limpieza eficiente. 20 años de garantía en el motor Digital Inverter.</p>
                <div class="cart-favorites">
                    <a href="#" class="btn-btn-primary"><i class="bi bi-cart"></i></a> 
                    <a href="#" class="btn-btn-secondary"><i class="bi bi-heart"></i></a>
                </div>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <h5 class="card-title">Lavadora Kalley</h5>
                <p class="card-text">Gran capacidad con ajuste de humedad automático para proteger las prendas.</p>
                <div class="cart-favorites">
                    <a href="#" class="btn-btn-primary"><i class="bi bi-cart"></i></a> 
                    <a href="#" class="btn-btn-secondary"><i class="bi bi-heart"></i></a>
                </div>
    ...
    <section> <!-- Crea la seccion para meter toda la informacion -->
        <div class="informacion"> <!-- FIXME: Productos, depronto lo quito -->
            <h3>Productos</h3>
                <li><a href="/Lavadoras/lavadoras.php">Lavadoras</a></li>
